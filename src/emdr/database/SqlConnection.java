...
public class SqlConnection implements Runnable {
    ...
    public SqlConnection(BlockingQueue queue, List<String> regions) throws MalformedURLException, ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
        this.queue = queue;
